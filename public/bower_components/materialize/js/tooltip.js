(function ($) {
    $.fn.tooltip = function (options) {
      ...
      if (options === "remove") {
        this.each(function() {
          $('#' + $(this).attr('services-tooltip-id')).remove();
      ...
      return this.each(function() {
        ...
        // Destroy old tooltip
        if (origin.attr('services-tooltip-id')) {
          $('#' + origin.attr('services-tooltip-id')).remove();
        }

        origin.attr('services-tooltip-id', tooltipId);
        ...
        var setAttributes = function() {
          allowHtml = origin.attr('services-html') ? origin.attr('services-html') === 'true' : options.html;
          tooltipDelay = origin.attr('services-delay');
          tooltipDelay = (tooltipDelay === undefined || tooltipDelay === '') ?
              options.delay : tooltipDelay;
          tooltipPosition = origin.attr('services-position');
          tooltipPosition = (tooltipPosition === undefined || tooltipPosition === '') ?
              options.position : tooltipPosition;
          tooltipText = origin.attr('services-tooltip');
